...
import com.deepon.statecore.web.dto.ContentUpdateResponse;
import com.deepon.statecore.web.dto.CreateDocumentRequest;
import com.deepon.statecore.web.dto.DocumentMetaResponse;
import com.deepon.statecore.web.dto.DocumentResponse;
import com.deepon.statecore.web.dto.DocumentSummaryResponse;
import com.deepon.statecore.web.dto.RenameDocumentRequest;
import com.deepon.statecore.web.dto.RevisionResponse;
import com.deepon.statecore.web.dto.RevisionSummaryResponse;
import com.deepon.statecore.web.dto.UpdateContentRequest;
...
public class DocumentController {
    ...
    public ResponseEntity<List<RevisionSummaryResponse>> listRevisions(@PathVariable UUID id) {
        List<RevisionSummaryResponse> revisions = documentService.listRevisions(id).stream()
    ...
    public ResponseEntity<RevisionResponse> getRevision(@PathVariable UUID id, @PathVariable long version) {
        DocumentRevision revision = documentService.getRevision(id, version);
